...
task = Task.init(
    project_name="examples", task_name="Tensorflow v2 mnist with summaries"
)
...
# These metrics accumulate the values over epochs and then print the
# overall result.
...
# Set up summary writers to write the summaries to disk in a different
# logs directory
