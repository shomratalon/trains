...
FLAGS = None
task = Task.init(
    project_name="examples", task_name="Tensorflow mnist with summaries example"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max_steps", type=int, default=300, help="Number of steps to run trainer."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            tempfile.gettempdir(), "tensorflow", "mnist", "input_data"
        ),
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.path.join(
            tempfile.gettempdir(), "tensorflow", "mnist", "logs", "mnist_with_summaries"
        ),
        help="Summaries log directory",
    )
    parser.add_argument(
        "--save_path",
        default=os.path.join(tempfile.gettempdir(), "model.ckpt"),
        help="Save the trained model under this path",
    )
    parser.add_argument("--batch_size", default=100, help="Batch size for training")
